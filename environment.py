...
class GraphicDisplay(tk.Tk):
    ...
    def _build_canvas(self):
        ...
        iteration_button.configure(width=10, activebackground="#33B5E4")
        ...
        policy_button.configure(width= 10, activebackground="#33B5E4")
        ...
        canvas.create_window(WIDTH * UNIT * 0.62, HEIGHT * UNIT + 16,
                             window=policy_button)
        policy_button = Button(self, text="Reset",
                               command=self.reset)
        policy_button.configure(width=10, activebackground="#33B5E4")
